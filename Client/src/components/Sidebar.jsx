...
// import all icons you need from lucide-react
    ...
    >
      ...
      <div className='w-full border-t border-gray-200 p-4 px-7 flex items-center justify-between'>
        ...
        <div onClick={openUserProfile} className='flex items-center gap-2 cursor-pointer'> 
            <img src={user.imageUrl} className='w-8 rounded-full' alt="profile-icon" />
            <div>
                <h1 className='text-sm font-medium'>{user.fullName}</h1>
                 <p className='text-xs text-gray-500'>  <Protect plan='premium' fallback='Free' >Preminum </Protect>Plan   </p>
            </div>
