  ...
  return (
    <div className="relative min-h-screen flex flex-col justify-center px-4 pb-14 sm:px-20 xl:px-32">
      ...
      >
        ...
        <circle cx="711.819" cy="372.562" r="308.334" stroke="#A0AEC0" strokeOpacity="1" />
        <circle cx="16.942" cy="20.834" r="308.334" stroke="#A0AEC0" strokeOpacity="1" />
        <path stroke="#A0AEC0" strokeOpacity="1" d="M-15.227 573.66H1439.7M-15.227 164.029H1439.7" />
        <circle cx="782.595" cy="411.166" r="308.334" stroke="#A0AEC0" strokeOpacity="1" />
      </svg>
      ...
      <div className="relative w-full py-6 mt-20 overflow-hidden">
        ...
        <div className="mx-auto w-[70%] overflow-hidden">
          <div className="flex animate-marquee">
            {companies.map((c, i) => (
              <span key={i} className="flex-shrink-0 mx-6 text-base sm:text-xl md:text-2xl font-semibold text-blue-600">
                {c}
              </span>
            ))}
            {companies.map((c, i) => (
              <span key={`dup-${i}`} className="flex-shrink-0 mx-6 text-base sm:text-xl md:text-2xl font-semibold text-blue-600">
                {c}
              </span>
            ))}
          </div>
