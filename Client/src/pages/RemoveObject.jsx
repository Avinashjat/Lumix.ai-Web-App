...
function RemoveObject() {
  ...
  const onSubmitHandler = async (e) => {
    ...
    if (!description || description.trim().length === 0)
      return toast.error(
        'Please provide a descriptive object name! (Example: "red apple on left")',
      );
  ...
  return (
    <div className="flex flex-wrap items-start gap-4 p-6 text-slate-700 overflow-y-scroll h-full">
      ...
      >
        ...
        />
        <p className="text-gray-500 pt-0 mt-0 text-xs">
          Supports JPG, PNG, WEBP
        </p>

        <p className="text-gray-700 mt-6 font-medium text-sm">
        ...
        <p className="text-xs text-gray-500 mt-2">
          Tip: include color, size, and position. If not resolved, try simpler:
          "red apple"
        </p>
        ...
        <div className="flex-1 flex justify-center items-center">
          {processedImage ? (
            ...
            <div className="text-sm flex flex-col items-center gap-5 text-gray-400">
              ...
              <p>
                Upload an image and provide a description to remove a specific
                object
              </p>
            </div>
          )}
